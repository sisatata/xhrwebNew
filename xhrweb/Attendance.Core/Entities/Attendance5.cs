...
{
    public class Attendance5 : BaseEntity<Guid>, IAggregateRoot, IAuditable
    {
        ...
        public Attendance5(Guid id) : base(id) { }
        private Attendance5() : base(Guid.NewGuid()) { }

        public static Attendance5 Create(
        ...
        {
            var oModel = new Attendance5(Guid.NewGuid());
        ...
        public void MarkAsDeleteAttendance5()
        {
            IsDeleted = true;
        }
