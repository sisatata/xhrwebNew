...
{
    public class Attendance8 : BaseEntity<Guid>, IAggregateRoot, IAuditable
    {
        ...
        public Attendance8(Guid id) : base(id) { }
        private Attendance8() : base(Guid.NewGuid()) { }

        public static Attendance8 Create(
        ...
        {
            var oModel = new Attendance8(Guid.NewGuid());
        ...
        public void MarkAsDeleteAttendance8()
        {
            IsDeleted = true;
        }
