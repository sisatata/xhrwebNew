...
{
    public class Attendance2 : BaseEntity<Guid>, IAggregateRoot, IAuditable
    {
        ...
        public Attendance2(Guid id) : base(id) { }
        private Attendance2() : base(Guid.NewGuid()) { }

        public static Attendance2 Create(
        ...
        {
            var oModel = new Attendance2(Guid.NewGuid());
        ...
        public void MarkAsDeleteAttendance2()
        {
            IsDeleted = true;
        }
