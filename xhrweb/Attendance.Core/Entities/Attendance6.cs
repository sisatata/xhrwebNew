...
{
    public class Attendance6 : BaseEntity<Guid>, IAggregateRoot, IAuditable
    {
        ...
        public Attendance6(Guid id) : base(id) { }
        private Attendance6() : base(Guid.NewGuid()) { }

        public static Attendance6 Create(
        ...
        {
            var oModel = new Attendance6(Guid.NewGuid());
        ...
        public void MarkAsDeleteAttendance6()
        {
            IsDeleted = true;
        }
