...
{
    public class Attendance12 : BaseEntity<Guid>, IAggregateRoot, IAuditable
    {
        ...
        public Attendance12(Guid id) : base(id) { }
        private Attendance12() : base(Guid.NewGuid()) { }

        public static Attendance12 Create(
        ...
        {
            var oModel = new Attendance12(Guid.NewGuid());
        ...
        public void UpdateAttendance12
            (
        ...
        public void MarkAsDeleteAttendance12()
        {
            IsDeleted = true;
        }
