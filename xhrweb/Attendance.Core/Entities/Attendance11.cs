...
{
    public class Attendance11 : BaseEntity<Guid>, IAggregateRoot, IAuditable
    {
        ...
        public Attendance11(Guid id) : base(id) { }
        private Attendance11() : base(Guid.NewGuid()) { }

        public static Attendance11 Create(
        ...
        {
            var oModel = new Attendance11(Guid.NewGuid());
        ...
        public void UpdateAttendance11
            (
        ...
        public void MarkAsDeleteAttendance11()
        {
            IsDeleted = true;
        }
