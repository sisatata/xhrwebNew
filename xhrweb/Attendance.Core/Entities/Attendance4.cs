...
{
    public class Attendance4 : BaseEntity<Guid>, IAggregateRoot, IAuditable
    {
        ...
        public Attendance4(Guid id) : base(id) { }
        private Attendance4() : base(Guid.NewGuid()) { }

        public static Attendance4 Create(
        ...
        {
            var oModel = new Attendance4(Guid.NewGuid());
        ...
        public void MarkAsDeleteAttendance4()
        {
            IsDeleted = true;
        }
