...
{
    public class Attendance3 : BaseEntity<Guid>, IAggregateRoot, IAuditable
    {
        ...
        public Attendance3(Guid id) : base(id) { }
        private Attendance3() : base(Guid.NewGuid()) { }

        public static Attendance3 Create(
        ...
        {
            var oModel = new Attendance3(Guid.NewGuid());
        ...
        public void MarkAsDeleteAttendance3()
        {
            IsDeleted = true;
        }
