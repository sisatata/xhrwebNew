...
{
    public class Attendance9 : BaseEntity<Guid>, IAggregateRoot, IAuditable
    {
        ...
        public Attendance9(Guid id) : base(id) { }
        private Attendance9() : base(Guid.NewGuid()) { }

        public static Attendance9 Create(
        ...
        {
            var oModel = new Attendance9(Guid.NewGuid());
        ...
        public void MarkAsDeleteAttendance9()
        {
            IsDeleted = true;
        }
