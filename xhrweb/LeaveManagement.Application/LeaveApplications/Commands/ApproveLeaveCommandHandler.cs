...
{
    public class ApproveLeaveCommandHandler : IRequestHandler<ApproveLeaveCommand, LeaveApplicationVM>
    {
        public ApproveLeaveCommandHandler(IAsyncRepository<LeaveApplication, Guid> leaveApplicationRepository,
        ...
        public async Task<LeaveApplicationVM> Handle(ApproveLeaveCommand request, CancellationToken cancellationToken)
        {
            ...
            try
            {
                ...
                leaveApplicationAggregate.ApproveLeaveApplication(request.Notes);
                ...
                if (leaveManagers.Any())
                {
                    ...
                    var @event = new Core.ApplicationEvents.LeaveApprovedEvent
                    {
