...
{
    public class ProcessLeaveBalanceCommandHandler : IRequestHandler<ProcessLeaveBalanceCommand, LeaveBalanceVM>
    {

        public ProcessLeaveBalanceCommandHandler(IReferenceRepository<Employee, Guid> employeeRepository,
        ...
        public async Task<LeaveBalanceVM> Handle(ProcessLeaveBalanceCommand request, CancellationToken cancellationToken)
        {
            ...
            try
            {
                ...
                await _leaveBalanceRepository.Update(leaveBalance).ConfigureAwait(false);
