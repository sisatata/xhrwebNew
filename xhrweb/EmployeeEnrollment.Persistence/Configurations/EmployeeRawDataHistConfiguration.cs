...
namespace EmployeeEnrollment.Persistence.Configurations
{
    ...
    public class EmployeeRawDataHistConfiguration : IEntityTypeConfiguration<EmployeeRawDataHist>
    {

        public void Configure(EntityTypeBuilder<EmployeeRawDataHist> builder)
        {
            ...
            builder.Property(hr => hr.Division).HasMaxLength(250);
