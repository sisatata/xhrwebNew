...
namespace EmployeeEnrollment.Persistence.Migrations
{
    ...
    [Migration("20211014083425_fileidaddedinprep")]
    partial class fileidaddedinprep
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("EmployeeEnrollment.Core.Entities.EmployeeEnrollment", b =>
                {
                    ...
                    b.Property<string>("LeaveTypeGroup")
                        .HasColumnType("character varying(50)")
                        .HasMaxLength(50);
            ...
            modelBuilder.Entity("EmployeeEnrollment.Core.Entities.EmployeePromotionTransfer", b =>
                {
                    ...
                    b.Property<short?>("NewPaymentOptionId")
                        .HasColumnType("smallint");
                    ...
                    b.Property<Guid?>("PreviousGradeId")
                        .HasColumnType("uuid");
                    ...
                    b.Property<short?>("PreviousPaymentOptionId")
                        .HasColumnType("smallint");

                    b.Property<Guid?>("PreviousPositionId")
                        .HasColumnType("uuid");

                    b.Property<Guid?>("PreviousSalaryStructureId")
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("EmployeeEnrollment.Core.Entities.EmployeeRawDataHist", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                    ...
                    b.Property<string>("NameofSpouce")
                        .HasColumnType("character varying(250)")
                        .HasMaxLength(250);
                    ...
                    b.Property<string>("PermanentDate")
                        .HasColumnType("character varying(250)")
                        .HasMaxLength(250);
                    ...
                    b.Property<Guid?>("planetEmployeeID")
                        .HasColumnType("uuid");

                    b.HasKey("Id");

                    b.ToTable("EmployeeRawDataHists");
                });

            modelBuilder.Entity("EmployeeEnrollment.Core.Entities.EmployeeRawDataPrep", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint")
                    ...
                    b.Property<string>("ConfirmationRuleName")
                        .HasColumnType("character varying(250)")
                        .HasMaxLength(250);
                    ...
                    b.Property<string>("LeaveTypeGroupName")
                        .HasColumnType("character varying(250)")
                        .HasMaxLength(250);
                    ...
                    b.Property<Guid>("RawFileDetailId")
                        .HasColumnType("uuid");
                    ...
                    b.ToTable("EmployeeRawDataPreps");
                });
            ...
            modelBuilder.Entity("EmployeeEnrollment.Core.Entities.PreviousPFGratuityEarnLeave", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.ToTable("PreviousPFGratuityEarnLeaves");
                });

            modelBuilder.Entity("EmployeeEnrollment.Core.Entities.RawFileDetail", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
