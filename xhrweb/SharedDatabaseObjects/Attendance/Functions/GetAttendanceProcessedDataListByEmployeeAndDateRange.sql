CREATE OR REPLACE FUNCTION attendance.getattendanceprocesseddatalistbyemployeeanddaterange(employeeid uuid, startdate timestamp without time zone, enddate timestamp without time zone)
...
AS $function$
	...
	RETURN QUERY
		SELECT 
		 ...
		 WHERE AttendanceProcessedData."EmployeeId" = employeeId 
