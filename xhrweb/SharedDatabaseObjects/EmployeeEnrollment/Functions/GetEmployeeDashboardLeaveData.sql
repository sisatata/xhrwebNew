CREATE OR REPLACE FUNCTION employee.getemployeedashboardleavedata(employeeid uuid)
...
declare startDate timestamp; endDate timestamp;
	begin
		...
		RETURN QUERY
			...
			where
				lb."EmployeeId" = employeeId and startDate between fy."FinancialYearStartDate"  and fy."FinancialYearEndDate" ;
	END;
$function$
;
