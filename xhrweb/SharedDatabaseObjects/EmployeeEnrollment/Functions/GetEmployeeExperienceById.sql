CREATE OR REPLACE FUNCTION employee.GetEmployeeExperienceById(experienceId uuid)
RETURNS TABLE (
		"Id" uuid ,
		"EmployeeId" uuid ,
...
AS $BODY$
	...
	RETURN QUERY
		SELECT 
		 ...
		 WHERE EmployeeExperience."IsDeleted" = False AND EmployeeExperience."Id" = experienceId;
	END;
$BODY$
LANGUAGE plpgsql;