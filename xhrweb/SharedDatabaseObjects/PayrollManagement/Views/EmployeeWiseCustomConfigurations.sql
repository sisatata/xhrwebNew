CREATE OR REPLACE VIEW payroll."EmployeeWiseCustomConfigurations"
AS SELECT
       CASE
   ...
   FROM main."DefaultConfigurations" dc
     ...
     LEFT JOIN employee."EmployeeCustomConfigurations" ecc ON cc."Code"::text = ecc."Code"::text AND e."Id" = ecc."EmployeeId" AND ecc."StartDate" <= CURRENT_DATE AND ecc."EndDate" >= CURRENT_DATE
