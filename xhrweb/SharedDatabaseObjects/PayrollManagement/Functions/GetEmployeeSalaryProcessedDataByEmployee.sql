CREATE OR REPLACE FUNCTION payroll.getemployeesalaryprocesseddatabyemployee(employeeid uuid, financialyearid uuid, monthcycleid uuid)
...
AS $function$
	...
	RETURN QUERY
		SELECT 
		 ...
		 WHERE EmployeeSalaryProcessedData."IsDeleted" = False and EmployeeSalaryProcessedData."EmployeeId"  = employeeId and EmployeeSalaryProcessedData."FinancialYearId"  =  financialYearId
...
--DROP FUNCTION payroll.getemployeesalaryprocesseddatabyemployee(uuid,uuid,uuid) ;