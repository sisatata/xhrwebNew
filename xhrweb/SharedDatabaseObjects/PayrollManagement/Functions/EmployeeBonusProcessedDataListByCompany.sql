CREATE OR REPLACE FUNCTION payroll.EmployeeBonusProcessedDataListByCompany(companyId uuid, bonusYearId uuid)
RETURNS TABLE (
		"Id" uuid,
		"EmployeeId" uuid ,
		"BonusTypeID" uuid ,
...
AS $BODY$
	...
	RETURN QUERY
		SELECT ebpd ."Id" ,
		 ...
		 WHERE ebpd."IsDeleted" = False and ebpd."FinancialYearId" = bonusYearId 
		and ebpd ."CompanyId" = companyId;
	END;
$BODY$
LANGUAGE plpgsql;


--DROP FUNCTION payroll.employeebonusprocesseddatalistbycompany(uuid,uuid);
--select * from payroll.EmployeeBonusProcessedDataListByCompany('ab5aeca2-7a4a-4a20-bb96-383e72e839dc', '5acdf203-d414-4e82-af3d-defe0921e89f');