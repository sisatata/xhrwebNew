CREATE OR REPLACE FUNCTION payroll.GetBonusConfigurationListByCompany(companyId uuid)
RETURNS TABLE (
		"Id" uuid ,
		"CompanyId" uuid ,
		"ReligionId" uuid ,
...
AS $BODY$
	...
	RETURN QUERY
		SELECT 
		 ...
		 WHERE BonusConfiguration."IsDeleted" = False and BonusConfiguration."CompanyId" = companyId ;
	END;
$BODY$
LANGUAGE plpgsql;


select * from payroll.GetBonusConfigurationListByCompany('ab5aeca2-7a4a-4a20-bb96-383e72e839dc');