...
AS $function$
	...
	RETURN QUERY
		SELECT 
			...
			b."BranchName" ,
             b."Id"  as "BranchId",
			Designation."SortOrder"  as "DesignationOrder",
			Employee."FullName" ,
		 ...
		 inner join payroll."EmployeeSalaries" es on es."EmployeeId" =EmployeeSalaryProcessedData."EmployeeId"
	    -- inner join payroll."EmployeeSalaryComponents" esc3 on esc3."EmployeeSalaryId" =es."Id" 
		 ...
		 inner join main."Departments" Department  on Department."Id" = EmployeeSalaryProcessedData."DepartmentId" 
