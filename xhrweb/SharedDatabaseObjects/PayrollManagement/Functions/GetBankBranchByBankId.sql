CREATE OR REPLACE FUNCTION payroll.GetBankBranchByBankId(bankId uuid)
RETURNS TABLE (
		"Id" uuid ,
...
AS $BODY$
	...
	RETURN QUERY
		SELECT 
		 ...
		 WHERE BankBranch."IsDeleted" = False and BankBranch."BankId" = bankId;
	END;
$BODY$
LANGUAGE plpgsql;

--select * from payroll.GetBankBranchByBankId('5ac263cb-467c-42b0-90fb-ae1ab7242f74');
