CREATE OR REPLACE FUNCTION payroll.getemployeesalarybyemployee(employeeid uuid)
...
AS $function$
	...
	RETURN QUERY
		SELECT 
		 ...
		 WHERE EmployeeSalary."IsDeleted" = False and EmployeeSalary."EmployeeId"  = employeeId;
	END;
$function$
;


--DROP FUNCTION payroll.getemployeesalarybyemployee(uuid) 
