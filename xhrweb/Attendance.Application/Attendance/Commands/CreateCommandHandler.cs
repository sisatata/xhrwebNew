...
{
    public class CreateCommandHandler : IRequestHandler<Commands.V1.CreateAttendance, AttendanceCommandVM>
    {
        ...
        public CreateCommandHandler(IAsyncRepository<AttendanceEntities.Attendance1, Guid> repository1,
        ...
        public async Task<AttendanceCommandVM> Handle(Commands.V1.CreateAttendance request, CancellationToken cancellationToken)
        {
            ...
            try
            {
                ...
                var @event = new Core.Events.AttendanceProcessEvent
                {
                    ...
                    StartDate = request.AttendanceDate.Value.Date,
                    EndDate = request.AttendanceDate.Value.Date
                };
