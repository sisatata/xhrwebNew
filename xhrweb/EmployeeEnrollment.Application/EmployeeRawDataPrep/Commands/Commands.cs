...
namespace EmployeeEnrollment.Application.EmployeeRawDataPrep.Commands
{
    public static class Commands
    {
        ...
        {
            public class StartEmployeeRawDataProcessing : IRequest<EmployeeRawDataPrepCommandVM>
            {
                public string FileName { get; set; }
                public Guid? CompanyId { get; set; }
            }
            public class CreateEmployeeRawDataPrep : IRequest<EmployeeRawDataPrepCommandVM>
            {
            ...
            public class UpdateEmployeeRawDataPrep : IRequest<EmployeeRawDataPrepCommandVM>
            {
            ...
            public class MarkAsDeleteEmployeeRawDataPrep : IRequest<EmployeeRawDataPrepCommandVM>
            {
