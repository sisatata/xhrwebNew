...
{
    public class CreateCommandHandler : IRequestHandler<Commands.V1.CreateEmployeeRawDataPrep, EmployeeRawDataPrepCommandVM>
    {
        public CreateCommandHandler(IAsyncRepository<EmployeeEntities.EmployeeRawDataPrep, Int64>
        repository)
        {
        ...
        public async Task<EmployeeRawDataPrepCommandVM> Handle(Commands.V1.CreateEmployeeRawDataPrep request, CancellationToken cancellationToken)
        {
